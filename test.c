...
int main() {
    ...
    while (fgets(command, COMMAND_LENGTH, stdin)!=NULL) {
        ...
        for(int clean = 0; clean < 15; clean++) {
        ...
        if(command_text == AGGIUNGI_STAZIONE) {
        ...
        if(command_text == DEMOLISCI_STAZIONE) {
        ...
        if(command_text == PIANIFICA_PERCORSO) {
